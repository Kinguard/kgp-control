helptext = {
	masterpassword_confirmation : "<p>Choose a strong password for encryption of OPI.<br>" +
			"This password is used to unlock OPI after each system restart</p>"+
	...
	opiname : "Select the name you wish to use to find your OPI.<br>"+
				"The full name (FQDN) will be 'opiname'.op-i.me",
	masterpassword : "Enter the <strong>master password<strong> to unlock OPI<br>"+
